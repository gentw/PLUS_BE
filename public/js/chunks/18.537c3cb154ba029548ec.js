...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var expenseData = expenseDatas;
    var resetExpenseData = function resetExpenseData() {
      expenseData.value = JSON.parse(JSON.stringify(blankExpenseData));
    };
    var onSubmit = function onSubmit() {
      _store__WEBPACK_IMPORTED_MODULE_7__["default"].dispatch('app-transaction/updateStockProduct', expenseData.value).then(function (response) {
