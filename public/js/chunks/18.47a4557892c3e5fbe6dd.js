...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var _useTransactionsList = Object(_useTransactionsList__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      ...
      fetchTotalOfVleraSum = _useTransactionsList.fetchTotalOfVleraSum,
    ...
    return {
      ...
      vleraSum: vleraSum,
      fetchTotalOfVleraSum: fetchTotalOfVleraSum
    };
  }
});
    ...
    [
      _c("transactions-list-edit", {
        ...
        on: {
          ...
          "fetch-total-of-vlera-sum": _vm.fetchTotalOfVleraSum,
        },
      }),
      _vm._v(" "),
      _c(
...
function useTransactionsList() {
  ...
  var stockProduct = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["ref"])({});
  var vleraSum = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["ref"])(0);
  ...
  var fetchTotalOfVleraSum = function fetchTotalOfVleraSum() {
    _store__WEBPACK_IMPORTED_MODULE_1__["default"].dispatch('app-transaction/fetchTotalOfVleraSum').then(function (response) {
      vleraSum.value = response.data;
    });
  };
  var fetchProduct = function fetchProduct(id) {
    _store__WEBPACK_IMPORTED_MODULE_1__["default"].dispatch('app-transaction/fetchProduct', id).then(function (response) {
