        ...
        <b-row>
          ...
          >
            <div class="d-flex align-items-center justify-content-end">
              ...
              >
                <span class="text-nowrap">Shto perdorues</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
...
">
          ...
          >
            ...
            <b-dropdown-item v-if="currentUserIsAdmin" @click="deleteUser(data.item.id)">
